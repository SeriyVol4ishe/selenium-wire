...
import seleniumwire.thirdparty.mitmproxy.flow
...
from seleniumwire.thirdparty.mitmproxy.utils import compat, human
...
class _OrderKey:
    ...
    def generate(self, f: seleniumwire.thirdparty.mitmproxy.flow.Flow) -> typing.Any:  # pragma: no cover
        pass
...
class OrderRequestStart(_OrderKey):
    def generate(self, f: seleniumwire.thirdparty.mitmproxy.flow.Flow) -> float:
        return f.timestamp_start


class OrderRequestMethod(_OrderKey):
    def generate(self, f: seleniumwire.thirdparty.mitmproxy.flow.Flow) -> str:
...
class OrderKeySize(_OrderKey):
    def generate(self, f: seleniumwire.thirdparty.mitmproxy.flow.Flow) -> int:
        if isinstance(f, http.HTTPFlow):
            size = 0
...
class View(collections.abc.Sequence):
    ...
    def _bisect(self, f: seleniumwire.thirdparty.mitmproxy.flow.Flow) -> int:
        v = self._view.bisect_right(f)
        return self._rev(v - 1) + 1

    def index(self, f: seleniumwire.thirdparty.mitmproxy.flow.Flow, start: int = 0, stop: typing.Optional[int] = None) -> int:
    ...
    def getvalue(self, flow: seleniumwire.thirdparty.mitmproxy.flow.Flow, key: str, default: str) -> str:
        """
    ...
    def setvalue_toggle(
        self,
        flows: typing.Sequence[seleniumwire.thirdparty.mitmproxy.flow.Flow],
        key: str
    ) -> None:
        """
    ...
    def duplicate(self, flows: typing.Sequence[seleniumwire.thirdparty.mitmproxy.flow.Flow]) -> None:
        """
    ...
    def remove(self, flows: typing.Sequence[seleniumwire.thirdparty.mitmproxy.flow.Flow]) -> None:
        """
    ...
    def resolve(self, flow_spec: str) -> typing.Sequence[seleniumwire.thirdparty.mitmproxy.flow.Flow]:
        """
    ...
    def add(self, flows: typing.Sequence[seleniumwire.thirdparty.mitmproxy.flow.Flow]) -> None:
        """
    ...
    def get_by_id(self, flow_id: str) -> typing.Optional[seleniumwire.thirdparty.mitmproxy.flow.Flow]:
        """
    ...
    def update(self, flows: typing.Sequence[seleniumwire.thirdparty.mitmproxy.flow.Flow]) -> None:
        """
...
class Focus:
    ...
    def __init__(self, v: View) -> None:
        self.view = v
        self._flow: typing.Optional[seleniumwire.thirdparty.mitmproxy.flow.Flow] = None
    ...
    @property
    def flow(self) -> typing.Optional[seleniumwire.thirdparty.mitmproxy.flow.Flow]:
        return self._flow

    @flow.setter
    def flow(self, f: typing.Optional[seleniumwire.thirdparty.mitmproxy.flow.Flow]):
...
class Settings(collections.abc.Mapping):
    ...
    def __getitem__(self, f: seleniumwire.thirdparty.mitmproxy.flow.Flow) -> dict:
