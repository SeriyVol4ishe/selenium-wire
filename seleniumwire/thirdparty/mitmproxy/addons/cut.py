...
class Cut:
    ...
    def cut(
        ...
        cuts: seleniumwire.thirdparty.mitmproxy.types.CutSpec,
    ) -> seleniumwire.thirdparty.mitmproxy.types.Data:
        """
    ...
    def save(
        ...
        flows: typing.Sequence[flow.Flow],
        cuts: seleniumwire.thirdparty.mitmproxy.types.CutSpec,
        path: seleniumwire.thirdparty.mitmproxy.types.Path
    ) -> None:
        """
        ...
        if path.startswith("+"):
            ...
            path = seleniumwire.thirdparty.mitmproxy.types.Path(epath)
        try:
