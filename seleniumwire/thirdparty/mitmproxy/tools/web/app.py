...
import seleniumwire.thirdparty.mitmproxy.tools.web.master  # noqa
...
def flow_to_json(flow: seleniumwire.thirdparty.mitmproxy.flow.Flow) -> dict:
    """
...
class RequestHandler(tornado.web.RequestHandler):
    ...
    @property
    def view(self) -> "seleniumwire.thirdparty.mitmproxy.addons.view.View":
        return self.application.master.view

    @property
    def master(self) -> "seleniumwire.thirdparty.mitmproxy.tools.web.master.WebMaster":
