...
from seleniumwire.thirdparty.mitmproxy.tools.console import flowdetailview
from seleniumwire.thirdparty.mitmproxy.tools.console import searchable
from seleniumwire.thirdparty.mitmproxy.tools.console import tabs
import seleniumwire.thirdparty.mitmproxy.tools.console.master  # noqa
...
class FlowDetails(tabs.Tabs):
    ...
    @property
    def flow(self) -> seleniumwire.thirdparty.mitmproxy.flow.Flow:
