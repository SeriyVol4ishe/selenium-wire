...
from seleniumwire.thirdparty.mitmproxy import command, command_lexer
...
from seleniumwire.thirdparty.mitmproxy.tools.console import keymap
...
class ConsoleAddon:
    ...
    def console_choose(
            ...
            cmd: seleniumwire.thirdparty.mitmproxy.types.Cmd,
            *args: seleniumwire.thirdparty.mitmproxy.types.CmdArgs
    ) -> None:
        """
    ...
    def console_choose_cmd(
            self,
            prompt: str,
            choicecmd: seleniumwire.thirdparty.mitmproxy.types.Cmd,
            subcmd: seleniumwire.thirdparty.mitmproxy.types.Cmd,
            *args: seleniumwire.thirdparty.mitmproxy.types.CmdArgs
    ) -> None:
        """
    ...
    @command.argument("part", type=seleniumwire.thirdparty.mitmproxy.types.Choice("console.bodyview.options"))
    ...
    @command.argument("flow_part", type=seleniumwire.thirdparty.mitmproxy.types.Choice("console.edit.focus.options"))
    ...
    def grideditor_load(self, path: seleniumwire.thirdparty.mitmproxy.types.Path) -> None:
        """
    ...
    def grideditor_load_escaped(self, path: seleniumwire.thirdparty.mitmproxy.types.Path) -> None:
        """
    ...
    def grideditor_save(self, path: seleniumwire.thirdparty.mitmproxy.types.Path) -> None:
        """
    ...
    @command.argument("mode", type=seleniumwire.thirdparty.mitmproxy.types.Choice("console.flowview.mode.options"))
